...
**[Awesome-Books-With-ES6]** is a website that allows users to add and remove books from a list.
...
```sh
cd capstone-project
git clone git@github.com:brighton0102/Awesome-Books-With-ES6.git
```
...
This project is [MIT](https://github.com/brighton0102/Awesome-Books-With-ES6/blob/main/LICENSE) licensed.
